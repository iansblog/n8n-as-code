...
// Configuration
const CACHE_DIR = path.join(__dirname, '../packages/agent-cli/src/assets/n8n-docs-cache');
const METADATA_FILE = path.join(CACHE_DIR, 'metadata.json');
const OUTPUT_FILE = path.join(__dirname, '../packages/agent-cli/src/assets/n8n-docs-complete.json');
